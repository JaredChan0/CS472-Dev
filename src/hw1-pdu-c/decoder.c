 ...
 */
 ...
 ip_toStr(arp->arp_hdr.spa, dst, sizeof(dst));
 printf("spa:   %s\n", dst);
 mac_toStr(arp->arp_hdr.sha, dst, sizeof(dst));
 printf("sha:   %s\n", dst);
 ip_toStr(arp->arp_hdr.tpa, dst, sizeof(dst));
 printf("tpa:   %s\n", dst);
 mac_toStr(arp->arp_hdr.tha, dst, sizeof(dst));
 printf("tha:   %s\n", dst);
